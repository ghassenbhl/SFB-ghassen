...
#[ApiResource(
    operations: [
        new Patch(
            // uriTemplate: '/threads/{thread_id}/messages/{message_id}/vote',
            uriTemplate: '/threads/messages/{id}/vote',
            controller: VoteMessageController::class,
            description: 'Add a vote on message',
            name: 'vote_message'
        )
        ],
